...
# Si usas el mismo contenedor, de lo contrario especifica uno diferente para static
AZURE_STATIC_CONTAINER = os.getenv('AZURE_STATIC_CONTAINER', AZURE_CONTAINER)
